...
public class LancamentoResource {
	...
	/*
	 * INJEÇÃO DO TIPO CONSTRUIDA public LancamentoResource(LancamentoService
	 * service, UsuarioService usuarioService) { this.service = service;
	...
	public ResponseEntity atualizarStatus(@PathVariable("id") Long id, @RequestBody AtualizaStatusDTO dto) {
		return service.obterPorId(id).map(entity -> {
			...
			if (statusSelecionado == null) {
				return ResponseEntity.badRequest().body("Não foi possivel atualizar o status de lançamento, envie um status válido.");
			}
			try {
