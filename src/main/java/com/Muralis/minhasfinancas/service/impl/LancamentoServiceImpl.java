...
public class LancamentoServiceImpl implements LancamentoService {
	...
	@Override
	// Abre uma transação e executa todo o conteudo do metodo
	// e ao finaliza ele realiza um commit se ocorrer tudo com sucesso
	// se der erro ele desfaz todas as alteraçoes realizadas
